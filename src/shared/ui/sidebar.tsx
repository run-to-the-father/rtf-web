    ...
    >
      ...
      >
        <div
          ...
          className='bg-sidebar group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow-sm flex h-full w-full flex-col group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border'
        >
          {children}
        </div>
      </div>
  ...
  return (
    <main
      ...
      className={cn(
        ...
        'md:peer-data-[variant=inset]:shadow-sm md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-2 md:peer-data-[variant=inset]:rounded-xl',
        className,
      )}
      {...props}
    />
...
function SidebarInput({
  ...
  return (
    <Input
      ...
      data-sidebar='input'
      className={cn('bg-background shadow-none h-8 w-full', className)}
      {...props}
    />
  );
}
